                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Gaji</div>
                                <div class="text-gray-600">Rp{{ number_format($employee['salary']) }}</div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Pinjaman</div>
                                <div class="text-gray-600">Rp{{ number_format($employee['debt']) ?? '-' }}
                                </div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Catatan</div>
                                <div class="text-gray-600">{{ $employee['debt_remark'] }}
                                </div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Tanggal Masuk</div>
                                <div class="text-gray-600">{{ date('d-m-Y', strtotime($employee['join_date'])) }}</div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bolder mt-5">Bank</div>
                                <div class="text-gray-600">{{ strtoupper($employee['bank_account']) }}</div>

                                <div class="fw-bolder mt-5">No Rekening</div>
                                <div class="text-gray-600">{{ $employee['account_number'] }}</div>
                                <!--begin::Details item-->
                            </div>
                        </div>
                        <!--end::Details content-->
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                            href="#kt_user_view_overview_tab">Riwayat Pinjaman</a>
                    </li>
                    <!--end:::Tab item-->
                    <!--begin:::Tab item-->
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                            href="#kt_user_view_overview_security">Pengamanan</a>
                    </li>
                    <!--end:::Tab item-->
                </ul>
                <!--end:::Tabs-->
                        ...
                        <div class="card card-flush mb-6 mb-xl-9">
                            ...
                            <div class="card-header mt-6">
                                ...
                                <div class="card-title flex-column">
                                    ...
                                    <div class="fs-6 fw-bold text-muted">Total 25 transaksi</div>
                                </div>
                                <!--end::Card title-->
                                <!--begin::Card toolbar-->
                                <div class="card-toolbar">
                                    <button type="button" class="btn btn-light-primary btn-sm" data-bs-toggle="modal"
                                        ...
                                        <!--end::Svg Icon-->Tambah Pinjaman</button>
                                </div>
                                <!--end::Card toolbar-->
                            </div>
                            <!--end::Card header-->
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center position-relative mb-7">
                                    ...
                                    <div class="fw-bold ms-5">
                                        <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Pinjaman
                                            awal</a>
                                        <!--begin::Info-->
                                        <div class="fs-7 text-muted">Rp300.000
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Details-->
                                ...
                                <div class="d-flex align-items-center position-relative mb-7">
                                    ...
                                    <!--begin::Details-->
                                    <div class="fw-bold ms-5">
                                        <a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Pembayaran
                                            melalui gaji periode Desember</a>
                                        <!--begin::Info-->
                                        <div class="fs-7 text-muted">Rp100.000
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                    <!--end::Details-->
