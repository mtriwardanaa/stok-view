                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Total Pegawai</th>
                            <th class="min-w-125px">Rek Debet</th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="{{ url('salary/detail', $salary['id']) }}"
                                                class="text-gray-800 text-hover-primary"
                                                data-name="{{ $salary['periode'] }}"
                                                data-id="{{ $salary['id'] }}">{{ $salary['periode'] }}</span>
                                        </div>
                                        <!--begin::User details-->
                                    </td>
                                    <!--end::User=-->
                                    <!--begin::Role=-->
                                    <td>Rp{{ number_format($salary['total_amount']) }}</td>
                                    <!--end::Role=-->
                                    <!--begin::Last login=-->
                                    <!--begin::Joined-->
                                    <td>{{ $salary['total_pegawai'] }}</td>
                                    <td>{{ $salary['rek_debet'] }}</td>
                                    <td>{{ $salary['tanggal_dibuat'] }}</td>
                                    <!--begin::Joined-->
                                    <!--begin::Action=-->
                                    <td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ url('gaji/export', $salary['id']) }}"
                                                    class="menu-link px-3">BNI Direct</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="{{ url('gaji/detail', $salary['id']) }}"
