    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <form id="formWithPrice" class="form" action="{{ url('form-masuk', $formMasuk['id']) }}" method="post">
                    @csrf
                    @method('PATCH')
                    <!--begin::Heading-->
                    ...
                    <div class="d-flex flex-column col-md-4 mb-5 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="Masukkan supplier"
                            name="supplier" value="{{ $formMasuk['supplier'] }}" required />
                    </div>
                        ...
                        <div class="table-responsive mb-5">
                            ...
                            <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700" data-kt-element="items">
                                ...
                                <tbody class="body-add">
                                    @foreach ($formMasuk['incoming_good_details'] as $key => $masuk)
                                        <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                            <td class="pe-7">
                                                <select name="good_ids[]" aria-label="Select a Timezone"
                                                    ...
                                                    @foreach ($goods as $good)
                                                        <option value="{{ $good['id'] }}"
                                                            @if ($good['id'] == $masuk['good_id']) selected @endif>
                                                            {{ $good['name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td class="ps-0">
                                                <input class="form-control form-control-solid" type="number" min="1"
                                                    name="qtys[]" placeholder="1" data-kt-element="quantity"
                                                    value="{{ $masuk['qty'] }}" required />
                                            </td>
                                            <td>
                                                <input type="text" class="price form-control form-control-solid text-end"
                                                    name="prices[]" value="{{ $masuk['price'] }}" placeholder="0.00"
                                                    data-kt-element="price" required />
                                            </td>
                                            <td class="pt-5 text-end">
                                                <button type="button"
                                                    class="btn btn-sm btn-icon btn-active-color-primary @if ($key != 0) btn-delete @endif"
