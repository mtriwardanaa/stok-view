    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <form id="kt_modal_new_ticket_form" class="form" action="{{ url('role', $role['id']) }}" method="post">
                    @csrf
                    @method('PATCH')
                    <!--begin::Heading-->
                    ...
                    <div class="d-flex flex-column col-md-4 mb-15 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="Masukkan label"
                            name="label" value="{{ $role['label'] }}" required />
                    </div>
                    <div class="d-flex flex-column col-md-4 mb-15 fv-row">
                        ...
                        @php
                            ...
                            $rolePermissions = array_values(array_unique(array_column($role['permissions'], 'id')));
                        @endphp
                                ...
                                @foreach ($permission as $item)
                                    <label
                                        ...
                                        <input class="form-check-input" type="checkbox" value="{{ $item['id'] }}"
                                            name="permission_ids[]" @if (in_array($item['id'], $rolePermissions)) checked @endif />
